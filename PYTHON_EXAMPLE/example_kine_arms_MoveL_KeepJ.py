"""
@file example_kine_arms_MoveJ_KeepJ.py
...
def main():
    ...
    pln_acc=100
    pln_freq=50
    arm0_start_pos=[17.470, -43.308, 11.804, -79.761, -10.700, -2.874, 9.134]
    arm1_start_pos=[-17.470, -43.308, -11.804, -79.761, 10.700, -2.874, -9.134]
    arm0_end_pos=[19.597, -32.480, 10.050, -58.939, -8.863, -33.821, 4.772]
    arm1_end_pos=[-19.597,-32.480,-10.050,-58.939,8.863,-33.821,-4.772]
    ...
    points0 = robot.plan_linear_keep_joints(0, arm0_start_pos, arm0_end_pos, pln_vel, pln_acc, pln_freq)
    ...
    points1 = robot.plan_linear_keep_joints(1, arm1_start_pos, arm1_end_pos, pln_vel, pln_acc, pln_freq)
